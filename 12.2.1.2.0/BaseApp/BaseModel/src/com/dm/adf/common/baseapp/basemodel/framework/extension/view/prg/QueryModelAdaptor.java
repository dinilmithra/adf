...
public class QueryModelAdaptor {
     ...
     * @param noUserParams
     */
    public QueryModelAdaptor(PrgViewObjectImpl sourceVO, QueryCollection qc,
                             Object[] params, int noUserParams) {
        if (qc != null) {
        ...
        queryModel.setFilterPramValues(buildFilterCriteria(qc, params,
                                                           noUserParams));
    }
     ...
     * @param rowset
     */
    public QueryModelAdaptor(PrgViewObjectImpl sourceVO,
                             ViewRowSetImpl rowset) {
    ...
    private Map<String, Object> buildFilterCriteria(ViewRowSetImpl rowset) {
            ...
            if (key != null && key.getAttributeCount() > 0) {
                ...
                if (attrDefImpls != null) {
                    ...
                    for (AttributeDefImpl attrDef : attrDefImpls) {
                        ...
                        filter.put(vo.getFilterAttributeNameToUse(attrDef.getName()),
                                   keyValue);
                    }
                }
            }
        ...
        ViewCriteriaManager vcm =
            rowset.getViewObject().getViewCriteriaManager();
            ...
            for (String vcName : vcNames) {
                ...
                while (vc.hasNext()) {
                    ...
                    for (ViewCriteriaItem vci : vcis) {
                        ...
                        if ((JboCompOper.OPER_EQ.equals(oper) ||
                             JboCompOper.OPER_LIKE.equals(oper) ||
     ...
     * @return
     */
    private Map<String, Object> buildFilterCriteria(QueryCollection qc,
                                                    Object[] params,
                                                    int noUserParams) {
            ...
            if (noUserParams > 0) {
                for (int z = 0; z < noUserParams; z++) {
                    ...
                    if (paramName != null && paramValue != null) {
                        filter.put(vo.getFilterAttributeNameToUse(paramName),
                                   paramValue);
                    }
                }
            }
