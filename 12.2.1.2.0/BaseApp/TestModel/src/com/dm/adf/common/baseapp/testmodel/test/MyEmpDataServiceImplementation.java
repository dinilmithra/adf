...
import com.dm.adf.common.baseapp.basemodel.framework.extension.view.prg.GenericQueryModel;
import com.dm.adf.common.baseapp.basemodel.framework.extension.view.prg.GenericRowCollection;
 ...
 */
public class MyEmpDataServiceImplementation implements GenericDataReadServiceInterface,
                                                       GenericDataPersistanceService {
    ...
    public static synchronized MyEmpDataServiceImplementation getInstance() {
        ...
        if (aDFContext.getSessionScope().get("SVC") == null) {
            ...
            vcImpl =
                    (MyEmpDataServiceImplementation)aDFContext.getSessionScope().get("SVC");
        }
        return vcImpl;
    }
    ...
    public GenericRowCollection executeServiceForCollection(GenericQueryModel queryModel) {
        ...
        ArrayList<GenericRowData> filteerdResultList =
