...
import com.dm.adf.common.baseapp.basemodel.framework.extension.util.prg.ConversionUtil;
import com.dm.adf.common.baseapp.basemodel.framework.extension.view.prg.DefaultTransactionContext;
 ...
 */
public abstract class PrgEntityObjectImpl extends EntityImpl {
    private DefaultTransactionContext txnCntxt = null;

    public PrgEntityObjectImpl() {
        super();
    }
