 ...
 *
 */
public abstract class PrgViewObjectImpl extends ViewObjectImpl {
    ...
    public PrgViewObjectImpl(String string, ViewDefImpl viewDefImpl) {
        super(string, viewDefImpl);
    }

    public PrgViewObjectImpl() {
        super();
    }
        ...
        if (!performingExecuteEmptyRowSet((QueryCollection)qc)) {
            if (!((QueryCollection)qc).getRowSetImpl().isFetchComplete()) {
                ...
                GenericRowCollection rowCollection =
                    executeServiceForCollection(new QueryModelAdaptor(this,
                                                                      (QueryCollection)qc,
                                                                      params,
    ...
    protected boolean hasNextForCollection(Object qc) {
        boolean bRet = false;
        GenericRowCollection rowColl =
            ((GenericRowCollection)getUserDataForCollection(qc));
        if (rowColl != null)
            ...
            if (rowColl.hasNext()) {
                ...
                if (values != null && values.getDataMap() != null) {
                    for (Object k : values.getDataMap().keySet()) {
                        ...
                        if (adef != null) {
                            populateAttributeForRow(r, adef.getIndex(),
                                                    values.getDataMap().get(k));
                        }
    ...
    public long getQueryHitCount(ViewRowSetImpl viewRowSet, Row[] masterRows) {
        ...
        return getService().getTotalRowCount((new QueryModelAdaptor(this,
                                                                    viewRowSet).getQueryModel()));
    ...
    protected ViewRowSetImpl createViewLinkAccessorRS(AssociationDefImpl assocDef,
        ...
        if (vo instanceof PrgViewObjectImpl) {
            ((PrgViewObjectImpl)vo).setViewLinkDefImpl(vldef);
        }
        return ret;
    }
